...
* Array che contiene la lista delle chiamate onready
* */
klynt.readyCallbacks = [];

/**
* Aggiunta MB Gestione progress
* Array che contiene la lista delle chiamate onprogress
* */
klynt.progressCallbacks = [];

/**
* Aggiunta MB - Add callback to player ready 
...
/**
* Aggiunta MB - Add callback to loading progress
* @param {function} callback - Callback function to add
* */
klynt.progress = function (callback) {
    if ($.isFunction(callback))
