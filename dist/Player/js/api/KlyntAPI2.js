 ...
 * */
/**
 * KlyntApi2 Cntrolla Klynt in un child frame
 * */

var KlyntAPI2 = (function () {
    ...
    KlyntAPIClass.prototype.init = function (klyntFrame) {

        if (!klyntFrame) {
            console.log('Warning KlyntApi2 not initialized!');
            return;
        }
        apiFrame = klyntFrame;
	...
	function postToChild(type, data) {
		data = data || {};
		data.header = {
            id: id,
            destination: CHILD,
